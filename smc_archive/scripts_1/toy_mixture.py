...
(V_tau, H_tau -- see smc_archive/scripts_2/weightings/doob_vtau.py) against a closed-form ground truth. Everything here is
...
E[x0 | x_sigma=x] for this prior -- i.e. the same role D_theta plays in smc_archive/scripts_2/weightings/doob_vtau.py, just
...
def batched_h_tau(mixture, x, sigma, y, r):
    ...
    over independent 1D particles sharing the same sigma. Same formula as smc_archive/scripts_2/weightings/doob_vtau.py's
