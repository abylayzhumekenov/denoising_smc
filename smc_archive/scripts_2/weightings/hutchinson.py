...
See smc_archive/scripts_2/hutchinson_findings.md for measured cost/variance on the real pretrained Burgers model.
"""
...
def estimate_laplacian(fn, x: Tensor, num_probes: int,
    ...
    smc_archive/scripts_2/hutchinson_findings.md before choosing num_probes for a real run.
    """
