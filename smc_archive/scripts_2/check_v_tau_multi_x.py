...
Usage: venv/bin/python -m smc_archive.scripts_2.check_v_tau_multi_x [num_probes] [num_points]
"""
...
def main():
    ...
    sigma_t_value = 5.0
    out_path = f'smc_archive/scripts_2/v_tau_multi_x_results_M{num_probes}_N{num_points}.json'
