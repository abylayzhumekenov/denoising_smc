...
# see smc_archive/scripts_2/hutchinson_findings.md); the double-backward route that originally motivated checking
# this is a separate, deprioritized track. Verify with `python -m smc_archive.scripts_2.check_gem_tds_real_model`
